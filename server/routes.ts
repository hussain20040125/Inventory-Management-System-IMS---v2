...
// N8N WEBHOOK HELPER
// ─────────────────────────────────────────────────────────────────
// .env variables — existing:
//   N8N_WEBHOOK_SECRET            – shared secret (X-Webhook-Secret header)
//   N8N_WEBHOOK_NEW_PO            – new PO created
//   N8N_WEBHOOK_GRN               – new GRN created
//   N8N_WEBHOOK_LOW_STOCK         – item stock dropped below minStock
//   N8N_WEBHOOK_SUPPLIER          – new supplier registration / create
//   N8N_WEBHOOK_MATERIAL_REQ      – new material requirement
//   N8N_WEBHOOK_INWARD            – new inward transaction
//   N8N_WEBHOOK_OUTWARD           – new outward transaction
//   N8N_WEBHOOK_STOCK_CHECK       – new stock check report submitted
//   N8N_WEBHOOK_PO_APPROVAL       – PO status changed
//   N8N_WEBHOOK_GENERIC           – fallback for all events
//
// .env variables — newly added:
//   N8N_WEBHOOK_LOGIN             – user login
//   N8N_WEBHOOK_INVENTORY_CREATE  – inventory item created
//   N8N_WEBHOOK_INVENTORY_UPDATE  – inventory item updated
//   N8N_WEBHOOK_INVENTORY_DELETE  – inventory item deleted
//   N8N_WEBHOOK_CATALOGUE_CREATE  – catalogue item created
//   N8N_WEBHOOK_CATALOGUE_UPDATE  – catalogue item updated
//   N8N_WEBHOOK_CATALOGUE_DELETE  – catalogue item deleted
//   N8N_WEBHOOK_SUPPLIER_UPDATE   – supplier updated
//   N8N_WEBHOOK_SUPPLIER_DELETE   – supplier deleted
//   N8N_WEBHOOK_PO_UPDATE         – PO updated (any field change)
//   N8N_WEBHOOK_PO_DELETE         – PO deleted
//   N8N_WEBHOOK_PLANNING_CREATE   – material plan created
//   N8N_WEBHOOK_PLANNING_UPDATE   – material plan updated
//   N8N_WEBHOOK_PLANNING_DELETE   – material plan deleted
//   N8N_WEBHOOK_MR_UPDATE         – material requirement updated
//   N8N_WEBHOOK_MR_DELETE         – material requirement deleted
//   N8N_WEBHOOK_QUOTATION_CREATE  – quotation created (auth)
//   N8N_WEBHOOK_QUOTATION_UPDATE  – quotation updated
//   N8N_WEBHOOK_QUOTATION_DELETE  – quotation deleted
//   N8N_WEBHOOK_WRITEOFF_CREATE   – write-off created
//   N8N_WEBHOOK_WRITEOFF_UPDATE   – write-off updated
//   N8N_WEBHOOK_WRITEOFF_DELETE   – write-off deleted
//   N8N_WEBHOOK_INWARD_UPDATE     – inward updated
//   N8N_WEBHOOK_INWARD_DELETE     – inward deleted
//   N8N_WEBHOOK_OUTWARD_UPDATE    – outward updated
//   N8N_WEBHOOK_OUTWARD_DELETE    – outward deleted
//   N8N_WEBHOOK_INWARD_RETURN     – inward return created
//   N8N_WEBHOOK_INWARD_RETURN_UPDATE  – inward return updated
//   N8N_WEBHOOK_INWARD_RETURN_DELETE  – inward return deleted
//   N8N_WEBHOOK_OUTWARD_RETURN        – outward return created
//   N8N_WEBHOOK_OUTWARD_RETURN_UPDATE – outward return updated
//   N8N_WEBHOOK_OUTWARD_RETURN_DELETE – outward return deleted
//   N8N_WEBHOOK_GRN_UPDATE        – GRN updated
//   N8N_WEBHOOK_GRN_DELETE        – GRN deleted
//   N8N_WEBHOOK_STOCK_CHECK_APPROVE – stock check approved
//   N8N_WEBHOOK_STOCK_CHECK_REJECT  – stock check rejected
//   N8N_WEBHOOK_USER_CREATE       – user created
//   N8N_WEBHOOK_USER_UPDATE       – user updated
//   N8N_WEBHOOK_USER_DELETE       – user deleted
//   N8N_WEBHOOK_ROLE_PERMISSION   – role permissions updated
//   N8N_WEBHOOK_SETTINGS          – settings updated
// ─────────────────────────────────────────────────────────────────
...
// webhookEventPrefix (optional): e.g. "INVENTORY" → fires INVENTORY_CREATE / INVENTORY_UPDATE / INVENTORY_DELETE
const createCrudRoutes = (
  ...
  router.put(`/${path}/:id`, authenticate, async (req: any, res) => {
    try {
      ...
      // n8n: update webhook — PO ke liye PO_UPDATE, baaki ke liye PREFIX_UPDATE
      if (webhookEventPrefix) {
  ...
  try {
    ...
    for (const item of body.items) {
      if (body.mrId) {
        ...
        // STEP 2 — Update MR Allocation if exists
        if (allocation) {
